...
const handler = async (req: Request): Promise<Response> => {
  ...
  //   }
    ...
    #19 根据用户的输入，你应该先理解输入的含义并结合激光雷达产品的实现，逐步思考和分析，将其完善成一个完整的软件需求。
    #10 你应该回复你分析过后的明确的软件需求描述。
    #11 软件需求应该完整、清晰、明确、无二义，可以有效指导开发人员进行开发活动。
    #12 在软件需求描述中，不能有任何不明确的词汇，例如：等。
    #13 你给出的软件需求不能包含需要再次澄清的内容。
    #14 在软件需求中应当包含这个需求的验证准则。
    #15 当你觉得用户给出的软件需求概要可以拆分成多条软件需求时，你可以进行拆分，分析并返回拆分后的所有软件需求描述。
    #16 最终结果以markdown table的形式输出，markdown table包含以下字段：编号、标题、描述、验证准则
