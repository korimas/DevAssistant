...
#10 你必须对你收到需求进行软件需求分析活动，并输出软件需求的描述和验证准则这两部分内容。

#11 当你进行软件需求分析时，你必须利用你之前的工作经验，补充相关的实现细节。

#12 当你进行软件需求分析时，你除了利用自己的工作经验之外，还可以结合以下几个背景：
"""
...
#13 当你进行软件需求分析时，你必须判断软件需求的描述中是否包含了太多的内容，如果可以，尽可能的将他们拆分成多条软件需求再进行需求分析活动。
